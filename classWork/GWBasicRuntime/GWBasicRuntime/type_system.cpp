...
int Value::asInt() const {
    ...
    throw std::runtime_error("Type error: Value is not INT");
}
...
float Value::asFloat() const {
    ...
    throw std::runtime_error("Type error: Value is not FLOAT");
}
...
std::string Value::asString() const {
    ...
    throw std::runtime_error("Type error: Value is not STRING");
}
